...
This defines the layout and callback functionality of the level surfaces subject tab.
    ...
    [
        ...
        dbc.Select(
            options=[
                ...
                {"label": "Tanglecube", "value": "Tanglecube"},
    ...
    function(button_click, preset) {
        if (button_click) {
            ...
            const preset_values = {
                ...
                "Tanglecube": {
                    "ls_fcomponent": "x^4 - 5 x^2 + y^4 - 5y^2 + z^4 - 5z^2 + 11.8",
