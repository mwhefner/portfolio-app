...
This defines webdg's analytics modal.
...
# Layout if no analytics are currently rendered
...
# layout for rendered curve analytics
curves = html.Div(
...
# Layout for rendered surface analytics
surfaces = html.Div(
...
# Stub for future embedded curves subject
...
# Layout for level surfaces stub
...
# Actual layout of the analytics modal
layout = dbc.Card(
    [
        dbc.CardBody(
            [
                html.Div(
                    ...
                    children = [
                        ...
                        # Again, just use the ol' "display none" trick
                        # so callbacks don't complain about the presense
                        # of id's
                        not_yet_rendered,
                        curves,
                        surfaces,
...
# Controls whether or not the analytics button is disabled
clientside_callback(
    """
...
# controls the color of the analytics button
clientside_callback(
    """
...
# controlling the style (namely css' `display`) to
...
# Plots the plotly plots for curves
clientside_callback(
...
# Clientside Callback for Gaussian Curvature (K) plotly plot
clientside_callback(
...
# Clientside Callback for Mean Curvature (H) plotly plot
clientside_callback(
...
# Clientside Callback for Principal Curvature k1 plotly plot
clientside_callback(
...
# Clientside Callback for Principal Curvature k2 plotly plot
clientside_callback(
